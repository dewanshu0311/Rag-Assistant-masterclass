...
# -------------------------
# UI styling — Premium Dark Glassmorphism
# -------------------------
THEME = """
<style>
...
body, .stApp {
    background: linear-gradient(135deg, var(--bg-primary) 0%, #0f172a 50%, #1a1035 100%) !important;
...
section[data-testid="stSidebar"] {
    background: linear-gradient(180deg, rgba(17, 24, 39, 0.95), rgba(15, 23, 42, 0.98)) !important;
...
.small-muted { color: var(--text-muted) !important; font-size: 13px; }
.kv { display: flex; gap: 12px; align-items: center; margin-bottom: 6px; }
.kv .key { color: var(--text-muted); width: 160px; }
.kv .val { color: var(--text-primary); font-weight: 600; }
.trace-link { color: var(--accent-3) !important; font-weight: 600; text-decoration: none; }

/* Animated gradient border on main content */
...
st.markdown("<p style='color: #94a3b8; font-size: 16px;'>Ask questions (RAG), run agent tasks, inspect retrieved chunks, and view LangSmith traces.</p>", unsafe_allow_html=True)
